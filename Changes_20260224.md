...
| `migrations/sql/0003_index_quote_tables.sql` | 修改 | 新增 11 个指数的 INSERT 语句 |
| `migrations/versions/0003_index_quote_tables.py` | 修改 | 新增 11 个指数的 INSERT 语句 |
| `migrations/versions/0009_add_global_markets_indices.py` | 新增 | 添加 8 个新指数到数据库 (DJI, IXIC, SPX, N225, FTSE, GDAXI, CSX5P, KS11) |
